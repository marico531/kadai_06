...
(async () => {
  ...
  // STEP2: 自分自身のカメラとマイクを取得して描画。オーディオとマイクが有効になるメソッド
  ...
  joinButton.onclick = async () => {
    ...
    // STEP5: 自分の音声と映像をpublishする。以下で３つ選べる。受信者に優しいシステム。
    ...
    // STEP6: 音声・映像の受信処理。これは説明が長いので３つに分ける；
    // STEP6-1: 音声・映像をsubscribe＝publicationを受信すること、した時の処理
    // 配信↓＿ほだん矢印受信
